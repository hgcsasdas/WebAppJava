...
<nav class="main-nav">
    <ul class="menu" id="menu">
        <li class="menu__item"><a href="index.jsp"><img class="logo" src="Imgs/logo.jpeg" alt=""></a></li>
        ...
        <li class="menu__item container-submenu">
            ...
            <ul class="submenu1">
                <li class="menu__item"><a href="cursos.jsp" class="menu__link">Cursos</a></li>
        ...
        <li class="menu__item" id="Plataformas"><a href="plataformas.jsp" class="menu__link">Plataformas</a></li>
        ...
        <li class="menu__item container-submenu">
            ...
            <ul class="submenu2">
                <li class="menu__item"><a href="iniciarsesion.jsp" class="menu__link">Iniciar sesión</a></li>
                <li class="menu__item"><a href="registrar.jsp" class="menu__link">Registrarse</a></li>
            </ul>
        </li>
        ...
        <li class="menu__item container-submenu">
            ...
            <ul class="submenu3">
                <li class="menu__item"><a href="moduleCreator.jsp" class="menu__link">Crear curso</a></li>
                <li class="menu__item"><a href="classCreator.jsp" class="menu__link">Crear Clase</a></li>
            </ul>
        </li>
    </ul>
</nav>