...
<script>
    ...
    function mostrarClase(datos){
        ...
        module.setAttribute('href', "examAsset.jsp?id="+datos['id_modulo']);
        document.querySelector(".contenidoClase").innerHTML = "<p><br>"+datos['contenido']+"</p><br><a class= 'editarClase' href='classCreator.jsp?id="+datos['id_modulo']+"&c="+datos['codigo_clase']+"' >Editar Clase</a>";
