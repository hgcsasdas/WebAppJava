...
<script class="mostrarModulos">
    function cambiaForm() {
        document.getElementById("rellenarDatos").action = 'CrearClase';
    }
    ...
    <div class="container-formulario-anadir">
        <form id="rellenarDatos" class="rellenar" action="#" method="post" autocomplete="off">
            <ul class="listaFormulario">
                ...
                <li><label for="nombre"> Título de la clase:</label><input id="nombre" name="nombre" type="text"
                                                                           required></li>
                <li><label for="modulo"> Módulo de la clase:</label><select name="codigo_modulo" id="modulo"
                                                                            required></select></li>
                <li><label for="video"> Link del vídeo:</label><input name="video" id="video" type="text" required></li>
                <li><label for="duracion"> Tiempo estimado leccion:</label><input id="duracion" name="duracion"
                                                                                  type="number" min="1"
                                                                                  required> Minutos
                </li>
                <li><label for="examen"> Link del examen:</label><input id="examen" name="examen" type="text" required>
                </li>
                <li><label for="duracionEx"> Tiempo estimado examen:</label><input id="duracionEx" name="duracionEx"
                                                                                   type="number"
                                                                                   min="1" required> Minutos
                </li>
